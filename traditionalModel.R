...
countries = data_medal_counts$NOC[which(data_medal_counts$Year==2024)]

gold_model = lm(Gold ~ Year + NOC, data = data_medal_counts)
total_model = lm(Total ~ Year + NOC, data = data_medal_counts)

predict_2028 = tibble(NOC = countries, Year = 2028)
